...
#undef NDEBUG // LMM assert()s are O(1) and vital
#include <assert.h>

/* Tiny blocks are not worth the space/time cost to track.  */
#define LMM_MIN_USEFUL (2 * 1024)
